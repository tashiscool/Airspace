...
- Simulation, TFM, Outcome Metrics, Decision, Pilot Brief, and Config pages also include page-level Safety Lab context panels, so local agent runs, policy guards, replay refs, evidence receipts, and review tasks stay beside the operational artifact they are auditing.
